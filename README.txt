...
Tags: Discord, Talk, Video Chat, Hang Out, Friends, Memberships, discord role management, lms, learnpress, learning community management, learnpress discord addon
...
1. Go to Plugins > Add New to find and install connect learnpress discord Addon.
...
== Screenshots ==
1. Install and activate the plugin and view the "Discord Settings" menu inside LearnPress LMS.
2. Map Discord roles and LearnPress Course.
3. Advanced settings.
