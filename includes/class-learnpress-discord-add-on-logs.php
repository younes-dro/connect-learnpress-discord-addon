 ...
 */
class LearnPress_Discord_Add_On_Logs {
	function __construct() {
		// Clear all existing logs.
		add_action( 'wp_ajax_ets_learnpress_discord_clear_logs', array( $this, 'ets_learnpress_discord_clear_logs' ) );
	}
	 ...
	 */
	public static $log_file_name = 'learnpress_discord_api_logs.txt';
...
new LearnPress_Discord_Add_On_Logs();
