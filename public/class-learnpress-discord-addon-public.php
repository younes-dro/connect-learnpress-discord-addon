...
//		}
	...
	public function ets_learnpress_discord_handler_send_dm( $user_id, $courses, $type = 'warning' ) {
		...
		if ( $type == 'course_complete' ) {
			...
			$message = ets_learnpress_discord_get_formatted_course_complete_dm( $user_id, $courses, $ets_learnpress_discord_course_complete_message );        
		}                
	...
	public function ets_learnpress_discord_login_with_discord (){
        ...
        public function ets_learnpress_discord_course_finished( $course_id, $user_id, $return ){
		...
		if ( $ets_learnpress_discord_send_course_complete_dm == true && $return ) {
			as_schedule_single_action( ets_learnpress_discord_get_random_timestamp( ets_learnpress_discord_get_highest_last_attempt_timestamp() ), 'ets_learnpress_discord_as_send_dm', array( $user_id, $course_id, 'course_complete' ), LEARNPRESS_DISCORD_AS_GROUP_NAME );
		}
        }
