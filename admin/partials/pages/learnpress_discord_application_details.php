...
<form method="post" action="<?php echo esc_url( get_site_url() ) . '/wp-admin/admin-post.php'; ?>">
  ...
  <div class="ets-input-group">
	<label><?php esc_html_e( 'Client ID', 'connect-learnpress-discord-addon' ); ?> :</label>
	...
	<div class="ets-input-group">
	  <label><?php esc_html_e( 'Client Secret', 'connect-learnpress-discord-addon' ); ?> :</label>
	...
	<div class="ets-input-group">
            <label><?php esc_html_e( 'Redirect URL', 'connect-learnpress-discord-addon' ); ?> :</label>
		...
		<p class="description"><?php esc_html_e( 'Registered discord app redirect url', 'connect-learnpress-discord-addon' ); ?><span class="spinner"></span></p>
                <p class="description ets-discord-update-message"><?php _e( sprintf( wp_kses( __( 'Redirect URL updated, kindly add/update the same in your discord.com application link <a href="https://discord.com/developers/applications/%s/oauth2/general">https://discord.com/developers</a>', 'connect-learnpress-discord-addon' ) , array( 'a' => array( 'href' => array() ) ) ) ,  $ets_learnpress_discord_client_id ) ); ?></p>                
	</div>
	<div class="ets-input-group">
            <label><?php esc_html_e( 'Admin Redirect URL Connect to bot', 'connect-learnpress-discord-addon' ); ?> :</label>
	...
	<div class="ets-input-group">
            ...
            ?>            
	  <label><?php esc_html_e( 'Bot Token', 'connect-learnpress-discord-addon' ); ?> :</label>
	...
	<div class="ets-input-group">
	  <label><?php esc_html_e( 'Server ID', 'connect-learnpress-discord-addon' ); ?> :</label>
	...
	<?php if ( empty( $ets_learnpress_discord_client_id ) || empty( $ets_learnpress_discord_client_secret ) || empty( $ets_learnpress_discord_bot_token ) || empty( $ets_learnpress_discord_redirect_url ) || empty( $ets_learnpress_discord_server_id ) ) { ?>
	  <p class="ets-danger-text description">
		<?php esc_html_e( 'Please save your form', 'connect-learnpress-discord-addon' ); ?>
	  </p>
	<?php } ?>
	<p>
	  ...
	  <?php
            ...
            ?>            
		<a href="<?php echo esc_url( $discord_authorise_api_url )?>" class="ets-btn learnpress-btn-connect-to-bot" id="learnpress-connect-discord-bot"><?php esc_html_e( 'Connect your Bot', 'connect-learnpress-discord-addon' ); ?> <i class='fab fa-discord'></i></a>
	  <?php endif; ?>
	</p>
</form>
