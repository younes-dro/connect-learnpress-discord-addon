...
<!--	<tr>
	...
	<small>Merge fields: [LP_STUDENT_NAME], [LP_STUDENT_EMAIL], [LP_QUIZ_NAME], [LP_QUIZ_DATE], [SITE_URL], [BLOG_NAME]</small>
	  ...
	  <tr>
		<th scope="row"><?php esc_html_e( 'Allow Discord Authentication before checkout?', 'connect-learnpress-discord-addon' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		...
		<td> <fieldset>
		<?php $retry_api_count_value = ( isset( $retry_api_count ) ) ? $retry_api_count : 5; ?>	
		<input name="ets_learnpress_retry_api_count" type="number" min="1" id="ets_learnpress_retry_api_count" value="<?php echo esc_attr( intval( $retry_api_count_value ) ); ?>">
		</fieldset></td>
	  </tr> 
	  <tr>
		<th scope="row"><?php esc_html_e( 'Set job queue concurrency', 'connect-learnpress-discord-addon' ); ?></th>
		<td> <fieldset>
		<?php $set_job_cnrc_value = ( isset( $set_job_cnrc ) ) ? $set_job_cnrc : 2; ?>
	  ...
	  <tr>
		...
		<td> <fieldset>
		<?php $set_job_q_batch_size_value = ( isset( $set_job_q_batch_size ) ) ? $set_job_q_batch_size : 6; ?>	
